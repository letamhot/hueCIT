    ...
    <div class="navbar-vertical">
        ...
        <ul>
            ...
            <li><a href="{{url('benhnhan')}}"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Quản lý bệnh
                    nhân</a></li>
            <li><a href="{{url('cosoyte')}}"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Quản lý cơ sở y
                    tế</a></li>
        ...
        <nav class="navbar btn bg navbar-style">
            <div class="text-left" style="width: 100%; display: flex; justify-content: space-between; ">
                ...
                <form class="form-inline" style="position: relative;">
                    ...
                    <a href="{{url('live_search')}}" class="fa fa-search btn-search" type="submit"></a>
                </form>
            </div>
            <div class="text-left">
            ...
            <div class="row flex-items-xs-bottom">
                ...
                <div class="col-sm text-right" style="padding-left: 56px;">
                    ...
                    <span id="dnn_dnnCopyright_lblCopyright" class="SkinObject" style="color: rgba(0,0,0,.9)">
                        <br>
                        <a href="https://www.facebook.com/Huecit/"><i class="fa fa-facebook-square"

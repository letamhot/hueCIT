  ...
  <div class="content" style="padding-left: 50px;">
    <nav class="navbar btn bg navbar-style">
      <div class="text-left" style="width: 100%; display: flex; justify-content: space-between; ">
        <div>
          <a href="{{url('home')}}"><img src="https://i.imgur.com/o5cQdRb.jpg" style="width: 50px; height: 50px"
              alt="home" /></a>
  ...
  <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" style="height: 500px; object-fit: cover;" src="{{ asset('img/a3.jpg') }}"
          alt="First slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" style="height: 500px; object-fit: cover;" src="{{ asset('img/a7.jpg') }}"
          alt="Third slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" style="height: 500px; object-fit: cover;" src="{{ asset('img/a4.jpg') }}"
          alt="Third slide">
      </div>
    </div>
      ...
      <div class="row flex-items-xs-bottom">
        <div id="dnn_Footer_1_Pane" class="col-sm">
          <div class="DnnModule DnnModule-DNN_HTML DnnModule-394"><a name="394"></a>
            ...
            <div class="contraC main">
              <div id="dnn_ctr394_ContentPane" class="contentpane">
                <!-- Start_Module_394 -->
        ...
        <div class="col-sm text-right" style="padding-left: 56px;">
          ...
          <span id="dnn_dnnCopyright_lblCopyright" class="SkinObject" style="color: rgba(0,0,0,.9)">
            ...
            <a href="https://www.youtube.com/channel/UC8cmtykxZSXeI5wFfeN-DmA"><i class="fa fa-youtube-play"
